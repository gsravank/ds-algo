...
def get_operations(start_idx, orig_str, curr_idx, remaining_cost):
    """
    Returns:
...
while total_cost < x and num_operations < 10**5 and operation_possible:
    ...
    current_operations, curr_cost, curr_idx, new_str = get_operations(non_overlaps[curr_nonoverlap_idx][0], orig_str, curr_idx, remaining_cost)
